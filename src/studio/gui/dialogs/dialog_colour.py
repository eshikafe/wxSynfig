...
# 
# wxSynfig/dialog_colour.py: Copyright (c) 2017 Austin Aigbe
#  
# Synfig/dialog_colour.cpp: Copyright (c) 2002-2005 Robert B. Quattlebaum Jr., Adrian Bentley
